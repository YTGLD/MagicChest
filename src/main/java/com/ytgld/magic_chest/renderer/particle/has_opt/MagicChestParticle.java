...
public class MagicChestParticle extends SingleQuadParticle {
    ...
    private MagicChestParticle(ClientLevel level, double x, double y, double z, SpriteSet sprite) {
    ...
    public record Provider(SpriteSet sprite) implements ParticleProvider<MagicColorOption> {
        ...
        @Override
        public @NotNull Particle createParticle(MagicColorOption simpleParticleType, ClientLevel clientLevel, double v, double v1, double v2, double v3, double v4, double v5, RandomSource textureAtlasSprite) {
            MagicChestParticle particle = new MagicChestParticle(clientLevel, v,v1,v2,sprite);
